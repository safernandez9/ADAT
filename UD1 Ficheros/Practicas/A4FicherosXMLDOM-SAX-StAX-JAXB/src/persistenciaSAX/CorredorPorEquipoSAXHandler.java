...
public class CorredorPorEquipoSAXHandler extends DefaultHandler {
    ...
    // Boolean para saber si el corredor pertenece al equipo buscado
    private boolean coincide = false;
    private String equipoBuscado;

    /**
     * Constructor que recibe el equipo a buscar
     * @param equipoBuscado
     */
    public CorredorPorEquipoSAXHandler(String equipoBuscado) {
    ...
    public void endElement(String uri, String localName, String qName){
        switch(qName) {
            case "velocista", "fondista" -> {
                if(corredorActual.getEquipo().equalsIgnoreCase(equipoBuscado)){
    ...
    private Corredor inicializarCorredorActual(String qName, Attributes attributes) {
        ...
        // Los switch con -> tienen una línea y devuelven un valor / objeto / resultado directamente
     ...
     * @return Lista de corredores procesados
     */
