...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        // Genero los datos del ejemplo y la fecha actual

        Registro registro = new Registro();
        registro.setVersion("1.0");
        registro.setFechaCreacion(LocalDate.of(LocalDate.now().getYear(), LocalDate.now().getMonth(), LocalDate.now().getDayOfMonth()));
